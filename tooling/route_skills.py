...
class SkillRouter:
    ...
    def _load_embeddings(self) -> None:
        ...
        with (self.embeddings_dir / "vectorizer.pkl").open("rb") as f:
            self.vectorizer = pickle.load(f)

        with (self.embeddings_dir / "vectors.pkl").open("rb") as f:
            self.vectors = pickle.load(f)

        with (self.embeddings_dir / "slugs.json").open() as f:
            self.slugs = json.load(f)

        with (self.embeddings_dir / "metadata.json").open() as f:
